<template>
  <article>
    ...
    <ShowImageRow :event=event :imgarray="[1,2]" :arrange="'sidebyside'"></ShowImageRow>
    ...
    <p>
      ...
      and submit elaborately to the pomp of a royal visit.  Not unlike us modern types with our virtual reality, cellphones and presidential visits.
    </p>
