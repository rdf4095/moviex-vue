...
export default {
    ...
    data() {
        return {
            event: null,
            cap: 'slot text from the view file.'
                //  'The movie depicts a Baghdad in which simplicity rules, ' +
                //  'in terms of color, design and special effects (note the ' +
                //  'animated effect for the genie).'
        }
    },
